...
void Application::Display(void)
{
	...
	//I THINK this is what you want us to do? Just switch the order around so the mid axis is freed from gimbal lock?
	m_m4Model = glm::rotate(IDENTITY_M4, glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f));
	m_m4Model = glm::rotate(m_m4Model, glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f));
	m_m4Model = glm::rotate(m_m4Model, glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f));
